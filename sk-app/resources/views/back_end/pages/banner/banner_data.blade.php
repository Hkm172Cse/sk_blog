                    ...
                    <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('images/banner/'.$val->image)}}" /></td>

                                <td>{{$val->btn_one}}</td>
                                <td>{{$val->btn_one_link}}</td>
                                <td>{{$val->btn_two}}</td>
                                <td>{{$val->btn_two_link}}</td>
                                <td>
                                    <a href="{{route('banner.edit.page',['id'=>$val->id])}}">
                                        <button class="btn btn-secondary btn-icon-text"><i class='fa fa-edit'></i></button>
                                    </a>
                                    ||
                                    <a href="{{route('banner_delete',['id'=>$val->id])}}"
