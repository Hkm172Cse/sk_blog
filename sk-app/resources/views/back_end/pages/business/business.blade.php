    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Home page business section</h4>
                    </div>
                    ...
                    <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$val->button_one}}</td>
                                <td>{{$val->button_two}}</td>
                                <td><img src="{{asset('/images/business/'.$val->image)}}" /></td>
                                <td>
                                    <a href="{{route('business.edit.page',['id'=>$val->id])}}">
                                        <button class="btn btn-secondary btn-icon-text"><i
                                                class='fa fa-edit'></i></button>
                                    </a>
                                    ||
                                    <a href="{{route('business.delete',['id'=>$val->id])}}"
