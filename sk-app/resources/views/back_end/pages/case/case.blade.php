    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Case page</h4>
                    </div>
                    ...
                    <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{substr($val->sort_title, 0, 20)}}</td>
                                <td><img src="{{asset('images/case/'.$val->image)}}" /></td>

                                <td>{{$val->link}}</td>
                                
                                <td>
                                    <a href="{{route('case.edit.page',['id'=>$val->id])}}">
                                        <button class="btn btn-secondary btn-icon-text"><i class='fa fa-edit'></i></button>
                                    </a>
                                    ||
                                    <a href="{{route('case.delete',['id'=>$val->id])}}"
