            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right mb-3">
                        <a href="{{route('add.client.client_list')}}">
                    ...
                    <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('images/client/'.$val->image)}}" /></td>
                                <td>
                                    <a href="{{route('client.list.edit',['id'=>$val->id])}}">
                                        <button class="btn btn-secondary btn-icon-text"><i
                                                class='fa fa-edit'></i></button>
                                    </a>
                                    ||
                                    <a href="{{route('client.list.delete',['id'=>$val->id])}}"
