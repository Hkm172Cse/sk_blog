    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                @if (\Session::has('update_logo'))
                <div class="alert alert-success">
                    {!! \Session::get('update_logo') !!}
                </div>
                @endif
                <div class="col-md-12 table-responsive">
                    <table id="example2" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$i}}</td>
                                <td><img src="{{asset('images/about/'.$logo->logo)}}"/></td>
                                <td>
                                    <a href="{{route('partner.logo.edit',['id'=>$logo->id])}}">
                    ...
                    <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$prt->des}}</td>
                                <td>
                                    <a href="{{route('partner.edit',['id'=>$prt->id])}}">
                                        <button class="btn btn-secondary btn-icon-text"><i
                                                class='fa fa-edit'></i></button>
                                    </a>
