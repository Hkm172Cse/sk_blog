    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Know about our community</h4>
                    </div>
                    <div class="col-md-6 text-right mb-3">
                        <a href="{{route('new.community')}}">
                ...
                <div class="col-md-12 table-responsive">
                    <table id="example2" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{++$i}}</td>
                                <td><img src="{{asset('images/about/'.$val->image)}}" alt="{{$val->image}}"/></td>
                                ...
                                <td>
                                    <a href="{{route('community.know.edit',['id'=>$val->id])}}">
