...
<div class="row">
    <div class="col-md-12 mb-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Community Banner Edit</h4>
                ...
                <form action="{{route('community_page.banner.update')}}" class="row mt-2" method="post" enctype="multipart/form-data">
                    @csrf
                    @foreach($data as $val)
                    <!-- Name -->
                    ...
                    <div class="col-md-6 techics-form-group">
                        ...
                        <input type="text" name="button" value="{{$val->button}}" id="input_field"
