    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Upcomming portfolio</h4>
                    </div>
                    <div class="col-md-6 text-right mb-3">
                        <a href="{{route('add.upcoming.portfolio')}}">
                    ...
                    <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$val->name}}</td>
                                <td>
                                    <a href="{{route('upcoming.portfolio.edit',['id'=>$val->id])}}">
                                        <button class="btn btn-secondary btn-icon-text"><i
                                                class='fa fa-edit'></i></button>
                                    </a>
                                    ||
                                    <a href="{{route('upcoming.portfolio.delete',['id'=>$val->id])}}"
