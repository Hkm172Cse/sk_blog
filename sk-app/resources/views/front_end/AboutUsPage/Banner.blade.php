    ...
    <div class="d-table-cell align-middle">
        <div class="container">
            <div class="banner-sec position-relative text-center">
                ...
                <p style="width:60%; margin:30px auto;">{{$val->title}}</p>
                <div class="banner-button d-inline-block" data-aos="fade-up" data-aos-duration="700">
                    <a class="d-inline-block" href="{{$val->link_one}}">Home</a>
                    <span>-</span>
                    <a class="d-inline-block" href="{{$val->link_two}}">About</a>
                </div>
            </div>
        </div>
    </div>
    <div class="top-button position-relative">
        <a id="button" href="{{$val->two}}" class="show"></a>
    </div>
</section>
@endforeach